...
<div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-white">
  <div class="fixed flex flex-col top-0 left-0 w-64 bg-slate-900 h-full border-r">
    <div class="flex items-center justify-center h-14 border-b">
      <div>Created ByHasir Ali</div>
    </div>
